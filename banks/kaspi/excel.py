...
class KaspiExcelExporter:
    ...
    def get_excel_template_path(self):
        return os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "kaspi_template.xlsx"
        )

    @classmethod
    def put_trxs_to_sheet(self, sheet, trxs: List[KaspiReport]):
    ...
    @classmethod
    def create_expenses_sheet(self, wb: Workbook, trxs: List[KaspiReport]):
    ...
    @classmethod
    def create_income_sheet(self, wb: Workbook, trxs: List[KaspiReport]):
    ...
    @classmethod
    def export_to_excel(self, trxs: List[KaspiReport], dest_path: str):
